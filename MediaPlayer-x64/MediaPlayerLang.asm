...
MPLangLoadStringID          PROTO dwLangID:DWORD, pStringTable:QWORD, dwStringID:DWORD, lpqwString:QWORD
...
; MPLangLoadStringID
;------------------------------------------------------------------------------
MPLangLoadStringID PROC FRAME USES RBX RCX dwLangID:DWORD, pStringTable:QWORD, dwStringID:DWORD, lpqwString:QWORD
    LOCAL pLangRecord:QWORD
    LOCAL nLangRecord:DWORD
    LOCAL bLangRecordFound:DWORD
    LOCAL pStringRecord:QWORD
